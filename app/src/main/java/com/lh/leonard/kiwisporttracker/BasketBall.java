...
public class BasketBall extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Sports basketballTeams[] = new Sports[]
                {
                        new Sports("Tall Blacks"),
                        new Sports("Breakers"),
                };

        SportsAdapter adapter = new SportsAdapter(this,
                R.layout.listview_item_row, basketballTeams);

        listView1 = (ListView) findViewById(R.id.listViewBasketball);

        View header = (View) getLayoutInflater().inflate(R.layout.listview_header_row, null);

        TextView headerValue = (TextView) header.findViewById(R.id.txtHeader);

        headerValue.setText("Basketball");
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                ...
                if (position == 1) {
                    Intent intent = new Intent(BasketBall.this, TallBlacksFixtures.class);
                    startActivity(intent);
                } else if (position == 2) {
                    Intent intent = new Intent(BasketBall.this, BreakersSchedule.class);
                    startActivity(intent);
                }
            }
