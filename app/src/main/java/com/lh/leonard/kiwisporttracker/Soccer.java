...
public class Soccer extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Sports soccerSports[] = new Sports[]
                {
                        // new Sports("FIFA U20's Soccer World Cup"),
                        new Sports("Wellington Phoenix")
                };

        SportsAdapter adapter = new SportsAdapter(this,
                R.layout.listview_item_row, soccerSports);


        listView1 = (ListView) findViewById(R.id.listViewSoccer);

        View header = (View) getLayoutInflater().inflate(R.layout.listview_header_row, null);

        TextView headerValue = (TextView) header.findViewById(R.id.txtHeader);
        headerValue.setText("Soccer");
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                ...
                if (position == 1) {
                    Intent intent = new Intent(Soccer.this, WellingtonPhoenixFixtures.class);
                    startActivity(intent);
                }
                //else if (position == 2) {
                //   Intent intent = new Intent(Soccer.this, FifaU20Fixtures.class);
                //   startActivity(intent);
                //     }
            }
        });
